...
func _get_global_code(mode):
	...
	var code = preload("depth_world_position.gdshader").code
...
func _get_code(input_vars, output_vars, mode, type):
	...
	var params =  [output_vars[0], input_vars[0]]
	return "%s = depth_texture_world_position(%s, SCREEN_UV, INV_PROJECTION_MATRIX);" % params
